define(function() {
    ...
    externals.createUser = async function postJSON(input) {
        // try {
          ...
          const response = await fetch("http://192.168.11.39:8080/doraemonAPI/api/create/", {
            method: "POST", // or 'PUT'
            headers: {
    ...
    externals.getUser = async function getJSON(input, cb) {
        const response = await fetch("http://192.168.11.39:8080/doraemonAPI/api/"+input);
    ...
    externals.updatePlanet = async function locationJSON(user){
        try {
          ...
          const response = await fetch("http://192.168.11.39:8080/doraemonAPI/api/"+user.name, {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
            },
