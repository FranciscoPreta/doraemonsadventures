define(function() {
    ...
    internals.createGameView = function(){
        ...
        let gameImage = $('<img>').attr('id', 'img1').attr('src','/img/sailorMoonInTrouble.png')
    ...
    internals.createButtons = function() {
        ...
        let buttonA = $('<button>').attr('id', 'optionA').attr('class', 'button').text('Suit up and fill in for him');
            buttonA.click(internals.handlers['optionA']);

        let buttonB = $('<button>').attr('id', 'optionB').attr('class', 'button').text('Look for a flower shop');
            buttonB.click(internals.handlers['optionB']);
            
        let buttonC = $('<button>').attr('id', 'optionC').attr('class', 'button').text('Give Tuxedo Mask a rose!');
            buttonC.click(internals.handlers['optionC']);
            
        let buttonD = $('<button>').attr('class', 'button').text("I'll come back later!");
